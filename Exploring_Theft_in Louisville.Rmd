...
dispersion_df<- change_by_zip%>%
  mutate(citywide_thefts_2007 = sum(change_by_zip$year_2007) - cumsum(year_2007),
         citywide_thefts_2016 = sum(change_by_zip$year_2016) - cumsum(year_2016))%>%
  mutate(citywide_change_after_zip_removal = round((((citywide_thefts_2016/citywide_thefts_2007)-1)*100), 2))%>%
  arrange(desc(citywide_change_after_zip_removal))%>%
  select(zip_code, citywide_thefts_2007, citywide_thefts_2016, citywide_change_after_zip_removal)


full_change <- data.frame(zip_code = "all", citywide_thefts_2007 = sum(change_by_zip$year_2007), 
                                  citywide_thefts_2016 = sum(change_by_zip$year_2016),
                                  citywide_change_after_zip_removal=round(((sum(change_by_zip$year_2016)/sum(change_by_zip$year_2007))-1)*100,2))
...
drug_dispersion<- drug_by_zip%>%
  mutate(citywide_drug_crimes_2007 = sum(drug_by_zip$year_2007) - cumsum(year_2007),
         citywide_drug_crimes_2016 = sum(drug_by_zip$year_2016) - cumsum(year_2016))%>%
  mutate(citywide_change_after_zip_removal = round((((citywide_drug_crimes_2016/citywide_drug_crimes_2007)-1)*100), 2))%>%
  arrange(desc(citywide_change_after_zip_removal))%>%
  select(zip_code, citywide_drug_crimes_2007, citywide_drug_crimes_2016, citywide_change_after_zip_removal)


drug_change <- data.frame(zip_code = "all", citywide_drug_crimes_2007 = sum(drug_by_zip$year_2007), 
                                  citywide_drug_crimes_2016 = sum(drug_by_zip$year_2016),
                                  citywide_change_after_zip_removal=round(((sum(drug_by_zip$year_2016)/sum(drug_by_zip$year_2007))-1)*100,2))
